...
def 조회():
    view_interface = gr.Interface(fn = view_records, inputs=None, outputs="dataframe", title="가계부", allow_flagging='never')
...
def 수정():
    ...
    index_interface = gr.Interface(fn = view_index, inputs=None, outputs="dataframe", title="가계부", allow_flagging='never')
